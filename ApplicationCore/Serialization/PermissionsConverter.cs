...
namespace ApplicationCore.Serialization
{
    ...
    //        else
    //        {
    //            throw new JsonSerializationException("Expected Permissions object value");
    //        }
    //    }
    ...
    //                try
    //                {
    //                    var v = Permissions.FromValue(Convert.ToInt32(reader.Value));
    //                    return v;
    //                }
    //                catch (Exception ex)
    //                {
